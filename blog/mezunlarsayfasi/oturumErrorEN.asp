...
<body>
    <p><a href="oturumError.asp">TR</a></p>
    <header>
            ...
            <section class="container main-left">
                ...
                <div class="card">
                    <div class="title">
                        ...
                        <div class="inputs">
                            <form method="POST" name=formcu action="loginEN.asp">
                                <h3>User Login</h3>
                                <span>E-Mail or Username</span>
                                <input name="username" idtype="text" class="" placeholder="Enter your e-mail or username">
                                <span>Password</span>
                                <input name="userpwd" type="password" class="" placeholder="Enter your password">

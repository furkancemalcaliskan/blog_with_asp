...
<body>
    <p><a href="indexRootEN.asp">EN</a></p>
    <header>
        ...
        <main class="container">
            <section class="container main-left">
                ...
                <div class="card">
                    ...
                    <div class="paragraph">
                        <p>
                            Siteyi dilediğiniz gibi yönetebilirsiniz.
                            <p><a href="default.asp">Ana Sayfaya Git</a></p>
                            <p><a href="rootVeritabani.asp">Kullanıcı Veritabanını Görmek İçin Tıklayınız</a></p>
                        </p>
                    </div>
    
                    <div class="image">
                        <img src="img/undraw_programming_2svr@2x.png" alt="adminFoto" title="">
                    </div>
                </div>

...
<body>
  <p><a href="forumYorumlarEN.asp">EN</a></p>
  <header>
...
<table border="1" width="85%" cellspacing="0" cellpadding="0" bordercolor="#000000" style="border-collapse: collapse; text-align:center">
  <tr>
    ...
    <td width="36%" style="border-style:solid; border-width:1; " bgcolor="#681630" >
    <b><font face="Verdana"color="#fff">Yorum</font></b></td>
  </tr>
<%
...
%>
  <tr>
    ...
    <td width="36%" style="border-style:solid; border-width:1; " bgcolor="#681630" ><font face="Tahoma" color="#fff" size="2" ><%=oRS("Yorum")%></font>&nbsp;</td>
  </tr>
<%	
	oRS.MoveNext
Loop

        ...
        <main class="container">
            <section class="container main-left">
                ...
                <div class="card">
                    ...
                    <div class="paragraph">
                        <p>
                            You can manage the site as you wish.
                            <p><a href="indexEN.asp">Go to Main Page</a></p>
                            <p><a href="rootVeritabaniEN.asp">Click to see the User Database</a></p>
                        </p>
                    </div>

...
<body>
    <p><a href="yorumKayitEN.asp">EN</a></p>
    <header>
        ...
        <main class="container">
            <section class="container main-left">
                ...
                <div class="card">
                    ...
                    <div class="paragraph">
                        <p>
                            <p><a href="forum.asp">Forum Sayfasına Geri Dön</a></p>
                            <p><a href="forumYorumlar.asp">Yorum Sayfasına Git</a></p>
                        </p>
                    </div>
    
                    <div class="image">
                        <img src="img/undraw_programming_2svr@2x.png" alt="saveFoto" title="">
                    </div>
                </div>

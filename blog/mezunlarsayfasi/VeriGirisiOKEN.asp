...
response.write ("<b>Missing information! </b> Please do not leave your E-mail and Password blank.   [ <a href=""javascript:history.back()"">Geri</a> ]<br><br> ")
response.end  
end if
...
response.redirect "userKayitEN.asp"
%>

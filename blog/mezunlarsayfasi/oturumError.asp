...
<body>
    <p><a href="oturumErrorEN.asp">EN</a></p>
    <header>
        ...
        <main class="container">
            ...
            <section class="container main-left">
                <div class="forum-title">
                    <h1>Hatalı E-Posta veya Şifre! Lütfen Tekrar Deneyiniz.</h1>
                </div>
                ...
                <div class="card">
                    <div class="title">
                        ...
                        <div class="inputs">
                            <form method="POST" name=formcu action="login.asp">
                                <h3>Giriş</h3>
                                <span>E-Posta</span>
                                <input name="username" idtype="text" class="" placeholder="E-posta adresinizi giriniz.">
                                <span>Şifre</span>
                                <input name="userpwd" type="password" class="" placeholder="Şifrenizi giriniz.">

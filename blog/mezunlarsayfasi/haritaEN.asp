...
<p align="center"><font face="WST_Swed" size="5"><b><font color="#FFFFFF">Map of Turkey</font></b></font><br>
&nbsp;</p>
...
<form method=post action="haritaEN.asp">     
...
<img border="0" src="https://www.kgm.gov.tr/SiteCollectionImages/KGMimages/Haritalar/turistik.jpg" width="862" height="531"></td>
 ...
 <input type="submit" value="&gt;" name="B4" style="font-weight: bold">
   ...
   <td width="56%" style="border-right: medium none #111111; border-top-style: none; border-top-width: medium; border-bottom-style: none; border-bottom-width: medium; border-left-style:none; border-left-width:medium" height="140" colspan="2">
    ...
    <p>&nbsp;</p>
    <p>  
 <input type="submit" value="Show Whole Photo" name="B4"></p>
    </td>
  </tr>
  <tr>
  ...
  <option>9</option>
  <option>10</option>
  </select> <b><font color="#FFFFFF" face="Arial">times</font></b></p>
    </td>
 ...
 <input type=hidden name=up value= "488597">
 <input type=hidden name=down value= "-1489749"> 
 <input type=hidden name=right value= "-4846714">
 <input type=hidden name=left value= "-8803405">  
	<p>  
	<br>
 <input type="submit" value="Enlarge" name="B4"></p>
 <input type="submit" value="Shrink" name="B4"> </p>
  </td>
  </tr>
  <tr>
    <td width="7%" style="border-style: none; border-width: medium" height="1">  
